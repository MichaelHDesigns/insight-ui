...
describe('basic UI tests', () => {
  ...
  beforeAll(async () => {
    ...
    const insightUIContainerOptions = {
      volumes: [
        `${rootPath}/helpthehomeless-node:/insight/node_modules/@Altcoin-Cash/insight-ui/helpthehomeless-node`,
        `${rootPath}/po:/insight/node_modules/@Altcoin-Cash/insight-ui/po`,
        `${rootPath}/public:/insight/node_modules/@Altcoin-Cash/insight-ui/public`,
      ],
    };
    ...
    await masterNode.helpthehomelessCore.getApi().generate(15);
  });
